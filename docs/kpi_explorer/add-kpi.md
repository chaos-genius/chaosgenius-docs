...
The column representing the `count` values of the rolled-up data, this column can also be proxy for count for the rolled up data i.e. not representing the actual count and can be an estimated value.
